# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-03-01 03:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account', verbose_name='回答者')),
            ],
        ),
        migrations.CreateModel(
            name='AnswerComment',
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account', verbose_name='评论者')),
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Answer')),
                ('reply_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.AnswerComment', verbose_name='基于评论的评论')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account')),
                ('course_section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.CourseSection')),
            ],
        ),
        migrations.CreateModel(
            name='City',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account', verbose_name='会员名')),
                ...
                ('p_node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.Comment', verbose_name='父级评论')),
            ],
        ),
        migrations.CreateModel(
            name='CouponRecord',
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account', verbose_name='拥有者')),
                ('coupon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Coupon')),
            ],
        ),
        migrations.CreateModel(
            name='CourseReview',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_recommend', models.BooleanField(default=False, verbose_name='热评推荐')),
                ('hide', models.BooleanField(default=False, verbose_name='不在前端页面显示此条评价')),
                ('course', models.ForeignKey(blank=True, help_text='不填写即代表评价整个学位课程', null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.Course', verbose_name='评价学位模块')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Course')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_students', to='baseapi.Account', verbose_name='导师')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.CourseChapter')),
            ],
        ),
        migrations.CreateModel(
            name='Industry',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentors', models.ManyToManyField(to='baseapi.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, help_text='不填用户的话代表给未注册用户发通知', null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.CharField(blank=True, max_length=255, null=True)),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Order')),
            ],
        ),
        migrations.CreateModel(
            name='Profession',
            fields=[
                ...
                ('industry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Industry')),
            ],
            options={
                'verbose_name': '职位信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account', verbose_name='提问者')),
                ('course_section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.CourseSection')),
                ('degree_course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.DegreeCourse')),
            ],
        ),
        migrations.CreateModel(
            name='ScoreRecord',
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account', verbose_name='被执行人')),
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('degree_course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.DegreeCourse', verbose_name='关联学位课程')),
            ],
        ),
        migrations.CreateModel(
            name='ScoreRule',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Course', verbose_name='学位模块')),
                ('enrolled_degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.EnrolledDegreeCourse')),
            ],
        ),
        migrations.CreateModel(
            name='StuFollowUpRdcord',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('attachment_path', models.CharField(blank=True, help_text='跟进记录的截图等', max_length=128, null=True, verbose_name='附件路径')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('enrolled_degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.EnrolledDegreeCourse', verbose_name='学生')),
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mentor', to='baseapi.Account', verbose_name='导师')),
            ],
        ),
        migrations.CreateModel(
            name='Tags',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Account')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='score_rule',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.ScoreRule', verbose_name='关联规则'),
        ),
        migrations.AddField(
            model_name='homewordrecord',
            name='homework',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Homework'),
        ),
        migrations.AddField(
            model_name='homewordrecord',
            name='mentor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_stu_homework_record', to='baseapi.Account', verbose_name='导师'),
        ),
        migrations.AddField(
            model_name='homewordrecord',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.EnrolledDegreeCourse', verbose_name='学生'),
        ),
        migrations.AddField(
            model_name='enrolleddegreecourse',
            name='order_detail',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='baseapi.OrderDetail'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='baseapi.EnrolledDegreeCourse'),
        ),
        migrations.AddField(
            model_name='degreecoursereview',
            name='enrolled_course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.EnrolledDegreeCourse'),
        ),
        migrations.AddField(
            model_name='degreecoursereview',
            name='tags',
            field=models.ManyToManyField(blank=True, to='baseapi.Tags', verbose_name='标签'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='courseschedule',
            name='study_record',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.StudyRecord'),
        ),
        migrations.AddField(
            model_name='coursereview',
            name='enrolled_course',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='baseapi.EnrolledCourse'),
        ),
        migrations.AddField(
            model_name='coursereview',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.Order', verbose_name='关联订单'),
        ),
        migrations.AddField(
            model_name='city',
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Province'),
        ),
        migrations.AddField(
            model_name='article',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.ArticleSource', verbose_name='来源'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
        ...
        migrations.AddField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseapi.Question', verbose_name='问题'),
        ),
        migrations.AddField(
            model_name='account',
            name='city',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.City', verbose_name='城市'),
        ),
        migrations.AddField(
            model_name='account',
            name='profession',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='baseapi.Profession', verbose_name='职位信息'),
        ),
        migrations.AddField(
            model_name='account',
            name='tags',
            field=models.ManyToManyField(blank=True, to='baseapi.Tags', verbose_name='感兴趣的标签'),
        ),
        migrations.AlterUniqueTogether(
            name='studyrecord',
